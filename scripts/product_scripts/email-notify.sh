...
# regex to validate email patterns
                        ...
                        <tr>
                            <td style="padding: 0 35px; background: linear-gradient(90deg, #0071c5 50%, #002b4b 100%);">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="min-height:45px;" class="responsive-table">
                                    <tr>
                                        <td><table border="0" cellpadding="0" cellspacing="0" class="logo"><tr><td><a href="https://portal.azure.com" target="_blank"><img src="https://azure.github.io/azure-sdk/images/azure-icon.png" width="50" height="50" alt="Azure" class="img-block"/></a></td><td color="#fff" style="padding: 0 5px 2px 9px; text-align: left; color: #fff; font-size: 22px; font-weight: 400;">Azure</td></tr></table></td>
                                    </tr>
                                    <tr>
